...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "pricing.launchDisclaimer": "As a new local service, our launch pricing is intentionally reduced by 50% compared with standard estimated rates. Final quotes may vary depending on access, terrain, waste volume, urgency, travel distance, and exact site conditions.",
    "pricing.preview.lawn": "from €27.50",
    "pricing.preview.garden": "from €27.50/h",
    "pricing.preview.robot": "from €39.50/month",
    "pricing.preview.winter": "from €69.50/month",
  ...
  fr: {
    ...
    "pricing.launchDisclaimer": "En tant que service local récent, nos tarifs de lancement sont volontairement réduits de 50 % par rapport aux estimations standards. Le devis final peut varier selon l’accès, le terrain, le volume de déchets verts, l’urgence, la distance de déplacement et les conditions exactes du site.",
    "pricing.preview.lawn": "dès 27,50 €",
    "pricing.preview.garden": "dès 27,50 €/h",
    "pricing.preview.robot": "dès 39,50 €/mois",
    "pricing.preview.winter": "dès 69,50 €/mois",
  ...
  de: {
    ...
    "pricing.launchDisclaimer": "Als neuer lokaler Service ist unser Einstiegspreis bewusst um 50 % gegenüber üblichen Schätzpreisen reduziert. Endgültige Angebote können je nach Zufahrt, Gelände, Abfallmenge, Dringlichkeit, Anfahrtsweg und genauer Objektlage abweichen.",
    "pricing.preview.lawn": "ab 27,50 €",
    "pricing.preview.garden": "ab 27,50 €/h",
    "pricing.preview.robot": "ab 39,50 €/Monat",
    "pricing.preview.winter": "ab 69,50 €/Monat",
  ...
  lu: {
    ...
    "pricing.launchDisclaimer": "Als neie lokale Service sinn eis Startpräisser absichtlech ëm 50 % méi niddreg wéi typesch Schätzpräisser. De finale Devis kann ofhänken vun Zougang, Terrain, Offallmengt, Dringlechkeet, Wee a geneeen Umstänn op der Plaz.",
    "pricing.preview.lawn": "of 27,50 €",
    "pricing.preview.garden": "of 27,50 €/h",
    "pricing.preview.robot": "of 39,50 €/Mount",
    "pricing.preview.winter": "of 69,50 €/Mount",
