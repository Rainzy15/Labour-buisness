...
const groups = [
  ["Grass care tools", ["Lawn mower", "Strimmer / edge trimmer", "Blower and rake", "Green waste bags"]],
    ...
    <Section className="bg-cream">
      <Container>
        <div className="mb-10 max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-8 text-charcoal/70">Practical, reliable equipment for clean finishes across grass care, hedges, terrace cleaning, and winter visits.</p>
        </div>
