...
export default function RobotPage() {
  const rows = [
    ["Upfront cost", "Approx. €1000 upfront", "From €69/month"],
      ...
      <Section className="bg-white">
        <Container>
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[["Small lawn", "up to 300 m²", "from €69/month"], ["Medium lawn", "301-600 m²", "from €89/month"], ["Large lawn", "601-1000 m²", "from €119/month"]].map(([name, size, price]) => (
