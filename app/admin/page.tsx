...
export default async function AdminPage() {
  const { bookings, customers, employees, equipment, contracts, invoices } = await getAdminOverviewData();
  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="rounded-[28px] bg-white p-6 shadow-sm">
        ...
        <p className="mt-2 text-sm text-charcoal/70">This dashboard now reads Supabase bookings, customers, employees, contracts, invoices, and equipment.</p>
